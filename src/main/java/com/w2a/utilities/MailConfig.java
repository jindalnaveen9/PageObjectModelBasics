...
public class MailConfig{
	...
	public static String from = "jindalnaveen9@gmail.com";
	public static String password = "jindal8750415123";
	public static String[] to ={"jindalnaveen9@gmail.com","jindalnaveen9@gmail.com"};
